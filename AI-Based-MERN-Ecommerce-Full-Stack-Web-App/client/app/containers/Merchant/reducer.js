...
const merchantReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case UPDATE_MERCHANT_ACTIVE_STATUS:
            return {
                ...state,
                merchants: state.merchants.map((merchant) =>
                    merchant._id === action.payload.id
                        ? { ...merchant, isActive: action.payload.isActive }
                        : merchant,
                ),
                searchedMerchants: state.searchedMerchants.map((merchant) =>
                    merchant._id === action.payload.id
                        ? { ...merchant, isActive: action.payload.isActive }
                        : merchant,
                ),
