...
export const SET_FORGOT_PASSWORD_STEP =
  'src/ForgotPassword/SET_FORGOT_PASSWORD_STEP';
export const SET_FORGOT_PASSWORD_LOADING =
  'src/ForgotPassword/SET_FORGOT_PASSWORD_LOADING';
